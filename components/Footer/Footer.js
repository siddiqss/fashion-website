...
import { bonFoyage, europaGrotesk, kaushanScript } from "../CoverVideo";
...
function Footer() {
  return (
    <section className="min-h-screen w-screen flex flex-col justify-center items-center bg-primary text-text relative">
      <div className="flex flex-col justify-center items-center">
        ...
        {/* <img src={Logo.src} alt="logo" className="w-[10vw] h-auto" fill="white" /> */}
        <h3
          className="text-4xl"
