"use client";
import { bonFoyage } from "@/components/CoverVideo";
...
function Loading() {
  ...
  return (
    <div className="absolute top-0 left-0 right-0 bottom-0 overflow-hidden touch-none w-screen h-screen z-20 flex items-center justify-center bg-grey text-text">
      <Link href={"/"} className="flex items-end">
        <svg
          //   width="48px"
          //   height="48px"
          className="w-[10vw] h-auto overflow-visible stroke-primary"
          viewBox="0 0 24 24"
          fill="none"
        ...
        <motion.span
          ...
          className="text-9xl text-primary pb-2 ml-1"
        >
          Chicity
        </motion.span>
      </Link>
